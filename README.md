...
| Case | Replay |
| --- | --- |
| CoM-Bar | [Open real-time tactile replay](demos/tactile_replays/com_bar.html) |
| Basket | [Open real-time tactile replay](demos/tactile_replays/basket.html) |
| Drill | [Open real-time tactile replay](demos/tactile_replays/drill.html) |
| Pan | [Open real-time tactile replay](demos/tactile_replays/pan.html) |
